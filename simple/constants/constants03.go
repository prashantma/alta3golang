...
func main() {
    ...
    // ./constants03.go:21:38: cannot use myString (constant "Hello" of type string) as type AltaString in variable declaration
    ...
    */
    ...
    // ./constants03.go:38:38: cannot use typedInt (constant 1 of type int) as type float64 in variable declaration
    /*
