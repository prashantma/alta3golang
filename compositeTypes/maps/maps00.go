...
func main() {
    ...
    // does not use "make"
    /*
    gamescrores: map[Zerg:9092]
panic: assignment to entry in nil map

goroutine 1 [running]:
main.main()
        /home/student/static/alta3golang/compositeTypes/maps/maps00.go:22 +0xdf
exit status 2
    */
    ...
    // "make" is must in the declaration of type
    ...
    values := map[string]int{
        ...
        "ghi": 567,
        "jkl": 897,
        // ./maps00.go:50:16: cannot use "larry" (untyped string constant) as int value in map literal
        //"mno": "larry",
    }
